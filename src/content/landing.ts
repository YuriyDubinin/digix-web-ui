...
export const landing: LandingContent = {
  ...
  hero: {
    ...
    title: 'Цифровые решения, которые двигают бизнес',
    subtitle:
  ...
  about: {
    title: 'О компании',
    lead: 'Команда инженеров, дизайнеров и продакт-менеджеров, которая превращает сложные бизнес-задачи в продукты с понятным интерфейсом и надёжной архитектурой.',
    body: 'Мы строим решения, которые приносят результат: от MVP за несколько недель до зрелых платформ с миллионами пользователей. Работаем на стыке продуктовой стратегии, инженерии и дизайна — и отвечаем за итог, а не за артефакты.',
    metrics: [
  ...
  process: {
    ...
    steps: [
      ...
      },
      {
        ...
        number: '04',
        title: 'Launch',
        description: 'Запуск в продакшен с нагрузочными тестами, мониторингом и планом отката. Никаких ночных деплоев в пятницу.',
      },
      {
        id: 'support',
        number: '05',
